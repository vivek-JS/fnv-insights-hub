...
import { warehouseSellTrend } from "@/data/fnvMockData";

const SellTrendChart = () => {
  return (
    <div className="glass-card rounded-xl p-5">
      <h3 className="text-sm font-semibold text-foreground">Warehouse Sell Trend (MoM)</h3>
      <p className="mb-4 text-xs text-muted-foreground">Amount in Lakhs (₹)</p>
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={warehouseSellTrend} barGap={2}>
